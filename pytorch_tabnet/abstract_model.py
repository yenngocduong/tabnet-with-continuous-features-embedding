...
class TabModel(BaseEstimator):
    ...
    cat_emb_dim: int = 1
    con_idxs: List[int] = field(default_factory=list)
    con_emb_dim: int = 1
    n_independent: int = 2
    n_shared: int = 2
    epsilon: float = 1e-15
    ...
    print("astract_model.py, con_idxs = ", con_idxs)
    ...
    def _set_network(self):
        print("In abstract_model.py, _set_network, con_idxs = ", self.con_idxs)
        ...
        self.reducing_matrix = create_explain_matrix(
            ...
            cat_emb_dim=self.network.cat_emb_dim,
            cat_idxs=self.network.cat_idxs,
            con_idxs=self.network.con_idxs,
            con_emb_dim=self.network.con_emb_dim,
            post_embed_dim=self.network.post_embed_dim,
        )
